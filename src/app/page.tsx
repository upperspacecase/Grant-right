    ...
    <div className="min-h-screen bg-paper text-ink">
      <header className="border-b rule">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-4 sm:py-5 flex items-center justify-between gap-3">
          <div className="font-display text-xl sm:text-2xl">Grant-Right</div>
      ...
      <section className="max-w-5xl mx-auto px-5 sm:px-8 pt-12 sm:pt-24 pb-12 sm:pb-16">
        ...
        <h1 className="font-display text-4xl sm:text-5xl lg:text-6xl leading-[1.05] max-w-prose2">
          Stop re-typing your bio in fifty-word increments.
        </h1>
        <p className="mt-5 sm:mt-6 text-base sm:text-lg text-muted max-w-prose2 leading-relaxed">
        ...
        <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-3">
          <Link href="/dashboard" className="btn btn-primary justify-center">
            Enter the prototype <ArrowRight size={13} />
          </Link>
          <Link href="/sign-up" className="btn btn-ghost justify-center">Sign up</Link>
        </div>
      ...
      <footer className="border-t rule">
        <div className="max-w-6xl mx-auto px-5 sm:px-8 py-6 sm:py-8 text-xs text-muted flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
